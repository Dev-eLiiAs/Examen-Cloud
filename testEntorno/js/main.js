...
const botonBla = document.getElementById("botonBlack");
const botonWi = document.getElementById("botonWhite");
botonBla.onclick = function cambNegro() {
    var enlace0 = document.head.getElementsByTagName("link")[0];
    enlace0.setAttribute("href", "css/blackstyle.css");
}
botonWi.onclick = function cambBlanco() {
    var enlace0 = document.head.getElementsByTagName("link")[0];
    enlace0.setAttribute("href", "css/whitestyle.css");
}
...
function analizarContrasenia() {
    ...
    if (password.value == "") {
        document.getElementById('mensajePasswordEmpty').innerHTML = ("Introduce la contraseña ");
...
function armarEstructuraCadena() {
    ...
    var caracter, secuencia = [cadenaIngresada];
    var i = 0;

    for (i; i >= caracter.length; i++) {
        secuencia = cadenaIngresada.charAt(i);
